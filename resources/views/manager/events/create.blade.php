                ...
                <div class="px-16 py-8 mx-auto">
                    ...
                    <form method="POST" action="{{ route('events.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea row="5" id="information" name="information" class="block mt-1 w-full">{{ old('information')}}</x-textarea>
                        </div>
                        ...
                        <div class="md:flex justify-between items-end">
                            <div class="mt-4">
                                ...
                                <x-jet-input id="max_people" class="block mt-1 w-full" type="number" name="max_people" :value="old('max_peple')" required />
                            </div>
